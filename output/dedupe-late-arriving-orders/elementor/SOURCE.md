# Source disclosure — dedupe-late-arriving-orders lab page
...
(indigo `#5A4FE5` / coral `#FF5A36` / teal `#0E9C8B` / amber `#D98F1B`
accents, ink `#14151A` text, warm off-white `#FBFBF8` background).
